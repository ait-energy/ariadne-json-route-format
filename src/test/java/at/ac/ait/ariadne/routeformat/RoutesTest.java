...
public class RoutesTest {
    ...
    public static void setup() throws JsonGenerationException, JsonMappingException, IOException {
        ...
        unimodalFootRoute = Route.builder()
                .withSegmentsAndAutomaticallyInferredFields(Arrays.asList(intermodalRouteExample.getFootSegment()))
                .build();
    }
    ...
    public void testFeaturesCarSharing() {
        Route carSharingRoute = Route.builder().withSegmentsAndAutomaticallyInferredFields(
                Arrays.asList(intermodalRouteExample.getCarSharingSegment())).build();
