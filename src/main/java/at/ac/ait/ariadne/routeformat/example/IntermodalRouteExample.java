...
public class IntermodalRouteExample {
	...
	private void initializeLocations() {
		...
		giefinggasseAit = PointOfInterest.createMinimal(new Coordinate("16.4265263", "48.2686617"))
				.setAddress(giefinggasse).setName("AIT").setPoiType("company");

		heinrichVonBuolGasseBusStop = PublicTransportStop.createMinimal(new Coordinate("16.42791", "48.26680"))
				.setName("Heinrich-von-Buol-Gasse/Siemensstraße");

		floridsdorfBusStop = PublicTransportStop.createMinimal(new Coordinate("16.40073", "48.25625"))
				.setName("Floridsdorf").setPlatform("C");

		floridsdorfSubwayStop = PublicTransportStop.createMinimal(new Coordinate("16.40050", "48.25618"))
				.setName("Floridsdorf").setPlatform("2 (U-Bahn)");

		neueDonauSubwayStop = PublicTransportStop.createMinimal(new Coordinate("16.39468", "48.24630"))
		...
		handelskaiSubwayStop = PublicTransportStop.createMinimal(new Coordinate("16.38541", "48.24173"))
				.setName("Handelskai").setPlatform("2");

		handelskaiSubwayEntry = PublicTransportStop.createMinimal(new Coordinate("16.3848877", "48.2416471"))
				.setName("Handelskai (Stationseingang)");

		handelskaiCitybike = SharingStation.createMinimal(new Coordinate("16.3847976", "48.2420356"))
		...
		friedrichEngelsPlatzCitybike = SharingStation.createMinimal(new Coordinate("16.3792033", "48.2441354"))
		...
		car2goPickup = Location.createMinimal(new Coordinate("16.377454", "48.24386"))
				.setAddress(new Address().setStreetName("Adalbert-Stifter-Straße").setHouseNumber("71"));

		adalbertStifterStrasse15 = Location.createMinimal(new Coordinate("16.3655", "48.23752"))
				.setAddress(new Address().setStreetName("Adalbert-Stifter-Straße").setHouseNumber("15"));

		privateBicycleHopsagasse = Location.createMinimal(new Coordinate("16.3715916", "48.246609"))
				.setAddress(new Address().setStreetName("Hopsagasse").setHouseNumber("5").setPostCode("1200"));

		antonKummererPark = PointOfInterest.createMinimal(new Coordinate("16.364074", "48.2350109"))
				.setPoiType("park").setName("Anton-Kummerer-Park");

		treustrasse92 = Location.createMinimal(new Coordinate("16.36329", "48.234077"))
				.setAddress(new Address().setStreetName("Treustraße").setHouseNumber("92").setPostCode("1200"));

		gaussplatz = Location.createMinimal(new Coordinate("16.369045", "48.2267"))
				.setAddress(new Address().setStreetName("Gaußplatz"));

		scholzgasse1 = Location.createMinimal(new Coordinate("16.3695", "48.2243"))
	...
	private RoutingRequest createRoutingRequest() {
		...
		GeoJSONFeature<GeoJSONPolygon> forbiddenPolygon = GeoJSONFeature
				.newPolygonFeatureFromCoordinatePoints(Arrays.asList(Arrays.asList(new Coordinate("16", "48"),
						new Coordinate("16.1", "48"), new Coordinate("16.1", "48.1"),
						new Coordinate("16.1", "48"), new Coordinate("16", "48"))));
	...
	private LinkedList<RouteSegment> createRouteSegments() {
		...
		geometryGeoJson = GeoJSONFeature.newLineStringFeature(giefinggasseAit, heinrichVonBuolGasseBusStop,
				new Coordinate("16.4263", "48.2682"), new Coordinate("16.42824", "48.26719"));
		...
		geometryGeoJson = GeoJSONFeature.newLineStringFeature(floridsdorfSubwayStop, handelskaiSubwayStop,
				new Coordinate("16.39468", "48.24630"));
		...
		geometryGeoJson = GeoJSONFeature.newLineStringFeature(handelskaiSubwayEntry, handelskaiCitybike,
				new Coordinate("16.3845846", "48.2418792"));
		...
		geometryGeoJson = GeoJSONFeature.newLineStringFeature(handelskaiCitybike, friedrichEngelsPlatzCitybike,
				new Coordinate("16.3838145", "48.2413853"), new Coordinate("16.3807639", "48.2442201"),
				new Coordinate("16.3793906", "48.2438237"));
		...
		geometryGeoJson = GeoJSONFeature.newLineStringFeature(friedrichEngelsPlatzCitybike, car2goPickup,
				new Coordinate("16.37763", "48.24369"));
		...
		geometryGeoJson = GeoJSONFeature.newLineStringFeature(car2goPickup, adalbertStifterStrasse15,
				new Coordinate("16.373601", "48.24218"));
		...
		geometryGeoJson = GeoJSONFeature.newLineStringFeature(adalbertStifterStrasse15, treustrasse92,
				new Coordinate("16.36515", "48.23729"), new Coordinate("16.3656", "48.23515"),
				new Coordinate("16.36288", "48.23509"));
		...
		geometryGeoJson = GeoJSONFeature.newLineStringFeature(treustrasse92, gaussplatz,
				new Coordinate("16.3644", "48.2311"), new Coordinate("16.36638", "48.22886"));
		...
		geometryGeoJson = GeoJSONFeature.newLineStringFeature(gaussplatz, scholzgasse1,
				new Coordinate("16.3688", "48.2263"), new Coordinate("16.3693", "48.2257"),
				new Coordinate("16.3697", "48.2256"));
