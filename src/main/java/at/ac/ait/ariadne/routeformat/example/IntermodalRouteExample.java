...
public class IntermodalRouteExample {
	...
	private void initializeLocations() {
		...
		giefinggasseAit = PointOfInterest.createMinimal(GeoJSONCoordinate.createFromStrings("16.4265263", "48.2686617"))
				.setAddress(giefinggasse).setName("AIT").setPoiType("company");

		heinrichVonBuolGasseBusStop = PublicTransportStop
				.createMinimal(GeoJSONCoordinate.createFromStrings("16.42791", "48.26680"))
				.setName("Heinrich-von-Buol-Gasse/Siemensstraße");

		floridsdorfBusStop = PublicTransportStop.createMinimal(GeoJSONCoordinate.createFromStrings("16.40073", "48.25625"))
				.setName("Floridsdorf").setPlatform("C");

		floridsdorfSubwayStop = PublicTransportStop.createMinimal(GeoJSONCoordinate.createFromStrings("16.40050", "48.25618"))
				.setName("Floridsdorf").setPlatform("2 (U-Bahn)");

		neueDonauSubwayStop = PublicTransportStop.createMinimal(GeoJSONCoordinate.createFromStrings("16.39468", "48.24630"))
		...
		handelskaiSubwayStop = PublicTransportStop.createMinimal(GeoJSONCoordinate.createFromStrings("16.38541", "48.24173"))
				.setName("Handelskai").setPlatform("2");

		handelskaiSubwayEntry = PublicTransportStop
				.createMinimal(GeoJSONCoordinate.createFromStrings("16.3848877", "48.2416471"))
				.setName("Handelskai (Stationseingang)");

		handelskaiCitybike = SharingStation.createMinimal(GeoJSONCoordinate.createFromStrings("16.3847976", "48.2420356"))
		...
		friedrichEngelsPlatzCitybike = SharingStation
				.createMinimal(GeoJSONCoordinate.createFromStrings("16.3792033", "48.2441354"))
		...
		car2goPickup = Location.createMinimal(GeoJSONCoordinate.createFromStrings("16.377454", "48.24386"))
		...
		privateBicycleHopsagasse = Location.createMinimal(GeoJSONCoordinate.createFromStrings("16.3715916", "48.246609"))
				.setAddress(new Address().setStreetName("Hopsagasse").setHouseNumber("5").setPostCode("1200"));

		antonKummererPark = PointOfInterest.createMinimal(GeoJSONCoordinate.createFromStrings("16.364074", "48.2350109"))
		...
		scholzgasse1 = Location.createMinimal(GeoJSONCoordinate.createFromStrings("16.3695", "48.2243"))
	...
	private RouteFormatRoot createRouteFormatRoot() throws JsonGenerationException, JsonMappingException, IOException {
		RouteFormatRoot root = new RouteFormatRoot().setRouteFormatVersion("X.Y-UNKNOWN").setRequestId("999")
				.setProcessedTimeNow().setStatus(Status.OK).setDebugMessage("Route calculated in 0.002 seconds")
				.setCoordinateReferenceSystem("EPSG:4326").setRequest(createRoutingRequest()).setRoutes(Arrays.asList(
	...
	private RoutingRequest createRoutingRequest() {
		...
		GeoJSONFeature<GeoJSONPolygon> forbiddenPolygon = GeoJSONFeature.createPolygonFeatureFromCoordinatePoints(
				Arrays.asList(Arrays.asList(GeoJSONCoordinate.createFromStrings("16", "48"),
						GeoJSONCoordinate.createFromStrings("16.1", "48"), GeoJSONCoordinate.createFromStrings("16.1", "48.1"),
						GeoJSONCoordinate.createFromStrings("16.1", "48"), GeoJSONCoordinate.createFromStrings("16", "48"))));
	...
	private LinkedList<RouteSegment> createRouteSegments() {
		...
		geometryGeoJson = GeoJSONFeature.createLineStringFeature(giefinggasseAit, heinrichVonBuolGasseBusStop,
				GeoJSONCoordinate.createFromStrings("16.4263", "48.2682"),
		...
		geometryGeoJson = GeoJSONFeature.createLineStringFeature(floridsdorfSubwayStop, handelskaiSubwayStop,
				GeoJSONCoordinate.createFromStrings("16.39468", "48.24630"));
		...
		geometryGeoJson = GeoJSONFeature.createLineStringFeature(handelskaiSubwayEntry, handelskaiCitybike,
				GeoJSONCoordinate.createFromStrings("16.3845846", "48.2418792"));
		...
		geometryGeoJson = GeoJSONFeature.createLineStringFeature(handelskaiCitybike, friedrichEngelsPlatzCitybike,
				GeoJSONCoordinate.createFromStrings("16.3838145", "48.2413853"),
				GeoJSONCoordinate.createFromStrings("16.3807639", "48.2442201"),
				GeoJSONCoordinate.createFromStrings("16.3793906", "48.2438237"));
		...
		geometryGeoJson = GeoJSONFeature.createLineStringFeature(friedrichEngelsPlatzCitybike, car2goPickup,
				GeoJSONCoordinate.createFromStrings("16.37763", "48.24369"));
		...
		geometryGeoJson = GeoJSONFeature.createLineStringFeature(car2goPickup, adalbertStifterStrasse15,
				GeoJSONCoordinate.createFromStrings("16.373601", "48.24218"));
		...
		geometryGeoJson = GeoJSONFeature.createLineStringFeature(adalbertStifterStrasse15, treustrasse92,
				GeoJSONCoordinate.createFromStrings("16.36515", "48.23729"),
		...
		geometryGeoJson = GeoJSONFeature.createLineStringFeature(treustrasse92, gaussplatz,
				GeoJSONCoordinate.createFromStrings("16.3644", "48.2311"),
		...
		// ### private car ###
		geometryGeoJson = GeoJSONFeature.createLineStringFeature(gaussplatz, scholzgasse1,
				GeoJSONCoordinate.createFromStrings("16.3688", "48.2263"), GeoJSONCoordinate.createFromStrings("16.3693", "48.2257"),
				GeoJSONCoordinate.createFromStrings("16.3697", "48.2256"));
		carFromGaussplatzToScholzgasse = new RouteSegment().setNr(++segmentNr).setFrom(gaussplatz).setTo(scholzgasse1)
				.setDistanceMeters(299)
				// 57 seconds ride
